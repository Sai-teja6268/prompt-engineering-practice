...
def main():
    while True:
        ...
        module_map = {
            ...
            '2': 'examples.13_02_input_guardrails',
            '3': 'examples.13_03_scope_guardrails',
            '4': 'examples.13_04_behavior_guardrails',
            '5': 'examples.13_05_output_guardrails',
            '6': 'examples.13_06_fallback_guardrails',
            '7': 'examples.13_07_input_guardrails',
            '8': 'examples.13_08_safety_guardrails',
            '9': 'examples.13_09_escalation_guardrails',
            ...
            '14': 'examples.13_14_bias_fairness_ethics',
            '15': 'examples.13_15_controlling_llm_behavior',
        }
